...
public class LinkedQueue<E> implements Queue<E>, Iterable<E> {
  ...
  private class QueueIterator implements Iterator<E> {
      ...
      private SinglyLinkedList<E> snapshot;

      private QueueIterator() {
          try {
              this.snapshot = list.clone();
          } catch (CloneNotSupportedException ex) {
              System.out.println("Problem cloning queue.");
          }
      }
      
      public void remove() throws UnsupportedOperationException {};
      public E next() {return snapshot.removeFirst();}
      public boolean hasNext() {return !snapshot.isEmpty();}
  }
